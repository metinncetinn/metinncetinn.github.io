document.addEventListener('DOMContentLoaded', function() {
	...
	const translations = {
		tr: {
			...
			project3Content: "NodeVNCViewer, VNC programı (TightVNC,Real VNC) kullanarak bilgisayarları web üzerinden kontrol etmenizi sağlayan bir NodeJS uygulamasıdır. Projedeki HTML sayfasını iframe yardımı ile sayfanızda istediğiniz boyutlarda kullanabilirsiniz.",
			project4Title: "Sohbet Odası",
			project4Content: "Bu proje, Python kullanılarak geliştirilmiş bir sohbet odası uygulamasıdır ve istemci-sunucu iletişimi için TCP ve UDP protokollerini kullanmaktadır. Sohbet odası, birden fazla istemcinin bağlanmasına ve gerçek zamanlı olarak mesaj alışverişi yapmasına olanak tanır.",
		...
		en: {
			...
			project1Title: "Voice Chat Application",
			project1Content: "This project is a voice chat and screen-sharing application developed using Python. Users can communicate via voice, send messages, and share their screens. The application can be used without registration, and users can receive automatic updates whenever a new version is released.",
			project2Title: "Blink and Talk",
			project2Content: "This project offers an innovative way to interact with a computer using eye blink detection. The system integrates a face network for eye blink detection, a database to store questions and answers, and a UDP server-client structure for communication.",
			project3Title: "NodeJS VNC Viewer",
			project3Content: "NodeVNCViewer is a NodeJS application that allows you to control computers over the web using VNC programs (TightVNC, Real VNC). You can use the HTML page in the project in any size you want on your page with the help of iframe.",
			project4Title: "Chat Room",
			project4Content: "This project is a chat room application developed using Python and uses TCP and UDP protocols for client-server communication. The chat room allows multiple clients to connect and exchange messages in real time.",
