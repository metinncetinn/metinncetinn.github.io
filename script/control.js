document.addEventListener('DOMContentLoaded', function() {
	...
	const translations = {
		tr: {
			...
			project3Title: "Sesli Sohbet Uygulaması",
			project3Content: "Bu proje, Python kullanılarak geliştirilmiş bir sesli sohbet ve ekran paylaşma uygulamasıdır. Kullanıcılar, sesli konuşabilir, yazışabilir ve ekran paylaşabilirler. Uygulamayı kayıt olmadan kullanabilir, otomatik güncellemeleri yayınlandığında alabilirsiniz.",
		...
		en: {
			...
			project3Title: "Voice Chat Application",
			project3Content: "This project is a voice chat and screen-sharing application developed using Python. Users can communicate via voice, send messages, and share their screens. The application can be used without registration, and users can receive automatic updates whenever a new version is released.",
